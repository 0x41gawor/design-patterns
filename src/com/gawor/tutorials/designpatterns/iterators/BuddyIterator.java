...
//---// C O N C R E T E   I T E R A T O R   3
public class BuddyIterator implements IIterator {
    //---// C O N C R E T E   C O L L E C T I O N
    Friends friendList;
    //---// I T E R A T I O N   S T A T E
    int iterationState;

    public BuddyIterator(Friends friendList) {
        this.iterationState = -1;
        // Here we configure our iterator to iterate by work. Code simplified as if it was wrote by 5yo kid
